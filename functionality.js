  document.addEventListener('DOMContentLoaded', () => {
            ...
            pillBtns.forEach((btn, index) => {
                ...
                const sampleQuestions = [
                    "how often should exersise",
                    "How much protein should I eat?",
                    "What are the best stretches for runners?"
                ];
                
                btn.addEventListener('click', () => {
                    inputField.value = "<span style = 'color : #blue'>" + sampleQuestions[index] + "</span>" ;
                });
            });
        ...
        responseBox.innerHTML += '<br><br>' + "<span style = 'color : #382416'>" + question + "</span>" + '<br><br>' //Change color later to Match Nathan's
